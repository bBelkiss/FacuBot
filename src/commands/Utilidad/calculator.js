const {
  ...
  module.exports = {
    data: new SlashCommandBuilder()
      .setName("calculator")
      .setDescription("¿Necesitas ayuda para tu tarea?")
      .toJSON(),
    ...
    run: async (client, interaction) => {
      try {
        ...
        collector.on("collect", async (i) => {
          ...
          if (value === "=") {
            try {
              ...
              data = "";
              extra = "Ocurrió un error. Por favor, clickea en 'AC' para reiniciar.";
            }
          } else if (value === "clear") {
            data = "";
            extra = "El resultado se mostrará aca";
        ...
        console.log(`Error en el comando de calculadora:\n\n${error}`);
      }
    },
  };